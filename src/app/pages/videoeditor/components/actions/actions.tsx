    ...
    <div className={styles.container}>
      ...
      <GoogleLogout
        ...
        onLogoutSuccess={() => {
          ...
          navigate('/apps/video-editor/')
        }}
      ></GoogleLogout>
      <Link to='/apps/video-editor/export'>
      ...
      <button className={styles.button} onClick={() => navigate('/apps/video-editor/about')} title='About'>
