...
export default function Properties({
  ...
  //   for (let i = 0; i < segment.keyframe.length; i++) {
  //     if (segment.keyframe[i].start + segment.start === currentTime) {
  ...
  //     if (
  //       segment.keyframe[currKeyframeIndex].x !== undefined ||
  //       segment.keyframe[currKeyframeIndex].y !== undefined
  //     )
  //       return true;
  //   } else if (property === "scale") {
  //     if (
  //       segment.keyframe[currKeyframeIndex].scaleX !== undefined ||
  //       segment.keyframe[currKeyframeIndex].scaleY !== undefined
  //     )
  //       return true;
  //   } else if (property === "crop") {
  //     if (
  //       segment.keyframe[currKeyframeIndex].trimBottom !== undefined ||
  //       segment.keyframe[currKeyframeIndex].trimTop !== undefined ||
  //       segment.keyframe[currKeyframeIndex].trimLeft !== undefined ||
  //       segment.keyframe[currKeyframeIndex].trimRight !== undefined
  //     )
  //       return true;
  //   }
  //   return false;
  ...
  //   if (insertPos === null) insertPos = segment.keyframe.length;

  //   let currKeyframeIndex = checkKeyframeExists();

  //   if (segment.keyframe.length === 1 && isButtonPressed === undefined) {
  //     currKeyframeIndex = 0;
  //   }

  //   if(segment.keyframe.length > 1 && property === "position")setPositionState(true);
  //   else if(segment.keyframe.length > 1 && property === "scale")setScaleState(true);
  //   else if(segment.keyframe.length > 1 && property === "crop")setCropState(true);

  //   if (currKeyframeIndex !== false) {
  //     let updatedKeyframe = {
  //       ...segment.keyframe[currKeyframeIndex],
  //       ...args,
  //     };
  ...
  //         ...segment,
  //         keyframe: [
  //           ...segment.keyframe.slice(0, currKeyframeIndex),
  //           ...segment.keyframe.slice(currKeyframeIndex + 1),
  //         ],
  //       });
  //     } else {
  //       updateSegment(selectedSegment, {
  ...
  //       ...segment,
  //       keyframe: [
  //         ...segment.keyframe.slice(0, insertPos),
  //         {
  ...
  //         },
  //         ...segment.keyframe.slice(insertPos),
  //       ],
  //     });
  //   }
  // };
  ...
  //   for (let i = 0; i < segment.keyframe.length; i++) {
  //     //@ts-ignore
  //     if (segment.start + segment.keyframe[i].start > currentTime) {
  //       if (property === "position") {
  //         if (
  //           segment.keyframe[i].x !== undefined ||
  //           segment.keyframe[i].y !== undefined
  //         )
  //           return i;
  //       } else if (property === "scale") {
  //         if (
  //           segment.keyframe[i].scaleX !== undefined ||
  //           segment.keyframe[i].scaleY !== undefined
  //         )
  //           return i;
  //       } else if (property === "crop") {
  //         if (
  //           segment.keyframe[i].trimBottom !== undefined ||
  //           segment.keyframe[i].trimTop !== undefined ||
  //           segment.keyframe[i].trimLeft !== undefined ||
  //           segment.keyframe[i].trimRight !== undefined
  //         )
  //           return i;
  //       }
  //     }
  ...
  //   for (let i = segment.keyframe.length - 1; i >= 0; i--) {
  //     //@ts-ignore
  //     if (segment.start + segment.keyframe[i].start < currentTime) {
  //       if (property === "position") {
  //         if (
  ...
  //               ? currentTime
  //               : segment.start + segment.keyframe[nextKeyframeIndex].start
  //           );
  //         }}
  //       >
  ...
  //               ? currentTime
  //               : segment.start + segment.keyframe[prevKeyframeIndex].start
  //           );
  //         }}
  //       >
