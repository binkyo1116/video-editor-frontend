...
import {getLayout, LayoutSetup, useLayout} from '../../core'
    ...
    <div
      ...
      style={
        hidden
          ? {
              background:
                aside.theme === 'dark' ? '#151521' : aside.theme === 'light' ? '#f5f8fa' : '',
            }
          : {}
      }
    >
        ...
        {aside.theme === 'dark' && (
          <Link to='/dashboard'>
            <img
              ...
              src={toAbsoluteUrl('/media/logos/ndtv-logo1.png')}
            />
          </Link>
        )}
        {aside.theme === 'light' && (
      ...
      <div className='aside-menu flex-column-fluid'>
        {!hidden && <AsideMenu asideMenuCSSClasses={classes.asideMenu} />}
      </div>
